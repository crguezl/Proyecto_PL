...
var generador_examen = (function() {
        ...
        performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
            ...
            switch (yystate) {
                case 1:
                    ...
                    break;
                case 2:
                    var titulo = $$[$0].replace(/\"/g, "");
                    this.$ = (HEAD_WEB + MENOR + "title" + MAYOR + titulo + MENOR + "/title" + MAYOR + NEXT_LINE);
                    this.$ += MENOR + "body" + MAYOR + NEXT_LINE;
                    this.$ += MENOR + "h2" + MAYOR + titulo + MENOR + "/h2" + MAYOR + NEXT_LINE;

                    break;
                case 3:
                    this.$ = P + $$[$0].replace(/\"/g, "") + END_P + NEXT_LINE;
                    break;
                case 4:
                    this.$ = ($$[$0 - 1] + $$[$0]);
                    break;
    ...
    var TRUE = "true";
    var FALSE = "false";
    var END_WEB = "&lt;p&gt;&lt;input type='submit' name='evaluar' value='Evaluar' /&gt;&lt;/p&gt;" + NEXT_LINE + "&lt;/form&gt;" + NEXT_LINE + "&lt;/body&gt;" + NEXT_LINE + "&lt;/html&gt;";
